 ...
 */
/**
 * This model implements programmable forwarding project view
 * <p/>
 *
...
exports.get = function(req, res){
	common.Content["zh-cn"].title="PF项目";
    common.Content["en"].title="PF Projects";
    ...
    monitor_entry.get_chain_list(false,function(err,results)
    {
        if(!results){
            ...
            res.render('monitor_mgr/pf_project_view', {
                nav_head: _UIData.Nav_head,
                nav_left:_UIData.Nav_left,
                nav_foot:_UIData.Nav_foot,
                content:_UIData.Content,
                head_active:"/pf_project_view",
                left_active:"/pf_project_view",//指示活动标签
